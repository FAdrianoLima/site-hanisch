...
export default function H28140() {
  const [imagemPrincipal, setImagemPrincipal] = React.useState(
    "/static/images/produtos/odonto/ho-18-01.png"
  );
          ...
          <div className={`${styles.box} `}>
           ...
           <span>LINHA ODONTO</span>
            ...
            <p>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Comprimento - 180mm{" "}
              </span>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Largura - 130mm{" "}
              </span>
              <span>
                {" "}
