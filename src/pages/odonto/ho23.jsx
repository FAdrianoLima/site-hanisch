...
export default function H28140() {
  const [imagemPrincipal, setImagemPrincipal] = React.useState(
    "/static/images/produtos/odonto/ho23-01.png"
  );
          ...
          <div className={`${styles.box} `}>
           ...
           <span>LINHA ODONTO</span>
            ...
            <p>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Comprimento - 230mm{" "}
              </span>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Largura - 160mm{" "}
              </span>
              <span>
                {" "}
