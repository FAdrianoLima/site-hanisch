...
export default function H28140() {
  const [imagemPrincipal, setImagemPrincipal] = React.useState(
    "/static/images/produtos/odonto/ho8.png"
  );
    ...
    <>
      ...
      >
        <div className={styles.interno}>
          <div className={`${styles.box} `}>
            ...
            <div className="flex flex-row justify-between ">
              <img
                ...
                src="/static/images/produtos/odonto/ho8.png"
                onClick={() =>
                  setImagemPrincipal(
                    "/static/images/produtos/odonto/ho8.png"
                  )
              ...
              <img
                className="cursor-pointer"
                src="/static/images/produtos/odonto/h32-01.jpg"
                onClick={() =>
                  setImagemPrincipal(
                    "/static/images/produtos/odonto/h32-01.jpg"
                  )
                }
              />
              ...
              <img
                className="cursor-pointer"
                src="/static/images/produtos/odonto/h37-90.jpg"
                onClick={() =>
                  setImagemPrincipal(
                    "/static/images/produtos/odonto/h37-90.jpg"
                  )
                }
              />
            </div>
          ...
          <div className={`${styles.box} `}>
           <div>
           <span>LINHA ODONTO</span>
            <h3>HO8</h3>
            <h4>Dimensões:</h4>
            <p>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Comprimento - 77mm{" "}
              </span>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Largura - 58mm{" "}
              </span>
              <span>
                {" "}
      ...
      <section className={styles.background}>
        <div className="flex flex-col w-full max-w-[90rem] text-center">
          ...
          <div className="flex flex-row">
            ...
            Matéria prima PSU/PSU Raw Material. <br />
