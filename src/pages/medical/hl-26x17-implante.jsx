...
export default function H28140() {
  const [imagemPrincipal, setImagemPrincipal] = React.useState(
    "/static/images/produtos/medical/hl-26x17-implante.jpg"
  );
        ...
        <div className={styles.interno}>
          ...
          <div className={`${styles.box} `}>
           ...
           <span>LINHA MEDICAL</span>
            <h3> HL 26x17 Implante</h3>
            <h4>Dimensões:</h4>
            <p>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Comprimento - 240mm{" "}
              </span>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Largura - 150mm{" "}
              </span>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Altura - 25mm{" "}
              </span>
            </p>
           </div>
