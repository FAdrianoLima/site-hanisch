...
export default function H28140() {
  const [imagemPrincipal, setImagemPrincipal] = React.useState(
    "/static/images/produtos/medical/h52-100.jpg"
  );
          ...
          <div className={`${styles.box} `}>
           ...
           <span>LINHA MEDICAL</span>
            ...
            <p>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Comprimento - 500mm{" "}
              </span>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Largura - 230mm{" "}
              </span>
              <span>
                {" "}
