...
export default function H28140() {
  const [imagemPrincipal, setImagemPrincipal] = React.useState(
    "/static/images/produtos/medical/h37-bandeja.jpg"
  );
          ...
          <div className={`${styles.box} `}>
           ...
           <span>LINHA MEDICAL</span>
            ...
            <p>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Comprimento - 360mm{" "}
              </span>
              <span>
                {" "}
              ...
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Altura - 27mm{" "}
              </span>
            </p>
           </div>
