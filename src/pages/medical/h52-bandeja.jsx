...
export default function H28140() {
  const [imagemPrincipal, setImagemPrincipal] = React.useState(
    "/static/images/produtos/medical/h52-bandeja.jpg"
  );
          ...
          <div className={`${styles.box} `}>
           ...
           <span>LINHA MEDICAL</span>
            ...
            <p>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Comprimento - 509mm{" "}
              </span>
              <span>
                {" "}
              ...
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Altura - 20mm{" "}
              </span>
            </p>
           </div>
