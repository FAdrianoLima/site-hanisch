...
export default function H28140() {
  const [imagemPrincipal, setImagemPrincipal] = React.useState(
    "/static/images/produtos/personalizado/h49-100-Ureteroscopio.png"
  );
        ...
        <div className={styles.interno}>
          ...
          <div className={`${styles.box} `}>
           ...
           <span>LINHA PERSONALIZADO</span>
            <h3> H49-100 Ureteroscópio Flexível</h3>
            <h4>Dimensões:</h4>
            <p>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Comprimento - 490mm{" "}
              </span>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Largura - 220mm{" "}
              </span>
              <span>
                {" "}
                <img src="/static/images/circulo-azul.png" alt="" /> Altura - 100mm{" "}
              </span>
              <span>
                {" "}
